    ...
    <div className="form">
      <form onSubmit={handleSubmit} className="form-field">
        ...
        <section className="form-section">
          ...
          <input type="text" name="word" className="form-input" onChange={(event) => {
                  setNewWord({newWord, word: event.target.value });
                }}></input>
        </section>
        <section className="form-section">
          <label className="form-label">Tradução</label>
          <input type="text" name="translation" className="form-input" onChange={(event) => {
                  setNewWord({newWord, translation: event.target.value });
                }}></input>
        </section>
        <section className="form-section">
          <label className="form-label">Definição</label>
          <input type="text" name="definition" className="form-input" onChange={(event) => {
